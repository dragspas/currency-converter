...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script type="text/javascript">
        // @note 
        // Frontend app is done just to be usable
        // did not have intention to present any FE skills, since it is not a requirement
        $(document).ready(function () {
            $.ajax({
                url: 'http://localhost/api/v1/currencies?default=0', // @note should be part of FE app config params
                method: 'GET',
                dataType: 'json',
            ...
            $('#calculate').click(function(e) {
                ...
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        displayError('Could not calculate. Please try again.');
                    }
                });
            });
